...
transparent est utilisé (zone-local dans ansible/roles/unbound/templates/unbound.conf.j2) pour ne définir que quelques enregistrements locaux tout en conservant la résolution récursive des autres noms. Il s'agit d'une spécificité personnelle qui est à adapter selon les besoins.
